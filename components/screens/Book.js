    ...
    return (
        <SafeAreaView style={portrait.container}>
            ...
            <View style={portrait.sectionStyle}>
                <MaterialCommunityIcons style={portrait.searchIcon} name="magnify" color={'#0d0202'} size={26} />
                <TextInput
